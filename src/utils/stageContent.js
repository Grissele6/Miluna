...
export const stageCopy = {
  ...
  embarazo: {
    welcome: 'Bienvenida. Durante el embarazo tu ciclo pausa — pero puedes seguir registrando cómo te sientes.',
    homeSubtitle: 'Un espacio para escuchar cómo te sientes cada día.',
    predictionCaveat: 'Durante el embarazo la predicción de regla no aplica. Anota síntomas y ánimo si te sirve.',
